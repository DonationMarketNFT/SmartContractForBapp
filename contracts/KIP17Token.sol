...
contract KIP17Metadata is KIP13, KIP17, IKIP17Metadata {
    ...
    string memory tokenNumber
        ...
        _tokenName[tokenId] = tokenName; // campaign name
        _tokenDescription[tokenId] = tokenDescription; // campaign description
        _tokenOwnerName[tokenId] = tokenOwnerName; // campaign 발행인 이른
...
contract KIP17MetadataMintable is KIP13, KIP17, KIP17Metadata, MinterRole {
    ...
    function mintWithTokenURI(
        ...
        _mint(to, tokenId);
        _setTokenURI(tokenId, tokenURI, tokenName, tokenDescription, tokenOwnerName, tokenAgencyUrl, tokenDate, tokenNumber);
        return true;
    }
}
